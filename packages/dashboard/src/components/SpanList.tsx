...
export function SpanList({
  ...
  totalCount,
  onPageChange,
}: SpanListProps): React.ReactElement {
        ...
        <table className="w-full text-[13px]">
          ...
          <tbody>
            {rootSpans.map((s) => {
              ...
              const isExpanded = s.traceId === selectedTraceId;
              ...
              const traceSpans = isExpanded
                ? allSpans.filter((sp) => sp.traceId === s.traceId)
                : [];
                ...
                <Fragment key={s.id}>
                  <tr
                    ...
                    className={
                      ...
                      (isSelected
                        ? "bg-lime-300/6 border-l-2 border-l-lime-300"
                        : fresh
                  ...
                  {isExpanded && (
                    <tr className="bg-zinc-900/20">
                      <td colSpan={6} className="border-b border-zinc-800">
                        <Waterfall
                          trace={traceSpans}
